...
@article{...}
```
If you already know how ILP works (or the theory behind our paper), you can safely skip to [the usage section](#basic-usage) where we describe our code in some detail. Otherwise, [the introduction](#introduction-how-ilp-works-and-some-terminology) provides the essentials to understand our method.
...
- [Introduction: how ILP works and some terminology](#introduction-how-ilp-works-and-some-terminology)
...
- [Using this package](#using-this-package)
  ...
  - [How `produce_jammed_configuration` works](#how-produce_jammed_configuration-works)
    - [The main ILP loop](#the-main-ilp-loop)
    - [Creating the final packing](#creating-the-final-packing)
  - [Changing the default options](#changing-the-default-options)
    - [List of default values](#list-of-default-values)
    - [Controlling `produce_jammed_configuration` with keyword arguments](#controlling-produce_jammed_configuration-with-keyword-arguments)
      - [Kwargs for controlling how constraints are assigned to `LP_model` and setting bounds on displacements](#kwargs-for-controlling-how-constraints-are-assigned-to-lp_model-and-setting-bounds-on-displacements)
      - [Kwargs for controlling convergence and termination criteria of ILP](#kwargs-for-controlling-convergence-and-termination-criteria-of-ilp)
      - [Kwargs for controlling precision of overlaps and force balance tests](#kwargs-for-controlling-precision-of-overlaps-and-force-balance-tests)
      - [Kwargs for controlling output printing on terminal](#kwargs-for-controlling-output-printing-on-terminal)
    - [Changing the solver/optimizer](#changing-the-solveroptimizer)
      - [Solvers we tried](#solvers-we-tried)
      - [Selecting solver and specifying its attributes](#selecting-solver-and-specifying-its-attributes)
      - [Testing different solvers](#testing-different-solvers)
      - [Setting the required precision](#setting-the-required-precision)
  - [A simple example and understanding the output](#a-simple-example-and-understanding-the-output)
  - [Types defined in this package](#types-defined-in-this-package)
    - [The `PeriodicNumber` type](#the-periodicnumber-type)
    - [The `Packing` type](#the-packing-type)
  - [Try it yourself!](#try-it-yourself)
    - [Some tests included](#some-tests-included)
...
# Introduction: how ILP works and some terminology 
...
- [ ] Add implementation of polydisperse configurations
