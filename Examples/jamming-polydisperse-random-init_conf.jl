...
@time jammed_packing_bi, info_convergence_bi, Γs_vs_t_bi, smax_vs_t_bi, iso_vs_t_bi = produce_jammed_configuration!(Xs0_bi, Rs_bi; ℓ0=ℓ0_bi, sqrΓ0=1.5,  max_iters=1000, initial_monitor=20, optimizer=optimizer, solver_attributes=solver_attributes) 
...
for (nd, d) in enumerate(ds)
    ...
    @time jammed_packing, info_convergence, Γs_vs_t, smax_vs_t, iso_vs_t = produce_jammed_configuration!(Xs0, Rs; ℓ0=ℓ0, sqrΓ0=1.5,  max_iters=3000, initial_monitor=20, optimizer=optimizer, solver_attributes=solver_attributes) 
    println("_______________________________________________________________________________________\n\n")
